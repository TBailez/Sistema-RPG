...
while True:
    if do.lower()=='criar jogador' or do =='cp':
        ...
        print('Coeficiente de HP:',(non2.get(au).get('chp')))
        print('MANA:',(non2.get(au).get('mana')))
        print('Coeficiente de MANA:',(non2.get(au).get('cmana')))
        ...
        print('inventario:\n','   arma:',non2.get(au).get('inventario').get('arma'))
        print('    armadura:',non2.get(au).get('inventario').get('armadura'))
        do = input('O que deseja fazer? \n')
        ...
        while x>0:
            ...
            while u2<(lenn):
                while u<(lenn):
                    if v[u2]==v2[u]:
                        if n[u] in nomes:
                            if (nomes.get(n[u]).get('hp'))<=0: break
                        if n[u] in npcs:
                            if (npcs.get(n[u]).get('hp'))<=0: break
                        ...
                        while quanti<q[u]:
                            ...
                            if esc.lower()=='desviar' or esc.lower()=='desvio' or esc.lower()=='d': non[nomedef].update({'hp':((non.get(nomedef).get('hp'))-danod)})
                            if esc.lower()=='bloquear' or esc.lower()=='bloqueio' or esc.lower()=='b': non[nomedef].update({'hp':((non.get(nomedef).get('hp'))-dano)})
                            if esc.lower()=='parrear' or esc.lower()=='parry' or esc.lower()=='p': non[nomedef].update({'hp':((non.get(nomedef).get('hp'))-danop)})
                            quanti=quanti+1
                        for z in n:
                            if z in nomes: 
                                if (nomes.get(z).get('hp'))<=0:
                                    u=0
                                    u2=0
                                    print(z,'morreu')
                                    n.remove(z)
            ...
            while True:
                ...
                if xstr.lower()=='s' or xstr.lower()=='sim':
                    x=1
                    break
                elif xstr.lower()=='e' or xstr.lower()=='especial':
                    x=1
                    break
                elif xstr.lower()=='n' or xstr.lower()=='nao':
                    x=0
                    break
                else: print('Não existe essa opção')
        for name in n:
        ...
        while aux3<10:
            ...
            if aux3==0 or aux3==1:
                ...
                if aux2=='s':
                    ...
                    aux2=0
            aux3+=1
        if jon.lower()=='jogador' or jon=='j': nomes.update({au:non[au]})
        else: npcs.update({au:non[au]})
        do = input('O que deseja fazer? \n')
    elif do=='s':
        ded={
            'nomes': nomes,
